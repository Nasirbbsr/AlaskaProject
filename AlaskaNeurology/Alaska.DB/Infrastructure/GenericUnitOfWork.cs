...
{
    public abstract class GenericUnitOfWork<TContext> : IUnitOfWork
          where TContext : DbContext
    {
        ...
        protected GenericUnitOfWork(IContextFactory<TContext> dbContextFactory)
        ...
        protected GenericUnitOfWork(TContext context)
        {
            _dbContext = context;
        }
